...
public class Psychic extends Pokemon {
	/**
	  Initializes a newly created <i>Psychic</i> object
	...
	*/
	public Psychic(String name, int HP, int damageDone) {
	...
	*/
	public Psychic(String name, int HP, int damageDone, int damageReceived) {
		super(name, HP, damageDone, damageReceived);
	}
	
	@Override
	public void attackedBy(Pokemon pokemon) {
		pokemon.attackPsychic(this);
	}
